...
export const appName = 'Home SWEETER';
...
export const profile = [
    {
        title: "Verified Listings & Hosts",
        img: "/home/1.jpg",
        text: "All properties and hosts go through a verification process before being listed.\n" +
            "Hosts must provide valid identification and proof of property ownership or authorization.",
        icon: "paint-brush",
    },
    {
        title: " Identity Verification",
        text: "Users (both renters and hosts) must verify their identity through government-issued IDs or social authentication.\n" +
            "Extra verification steps (e.g., phone number verification) enhance security.",
        icon: "quote-left",
        img: "/home/2.jpg",
    },
    {
        title: " 24/7 Customer Support & Dispute Resolution",
        text: "A dedicated support team is available to assist with booking issues, cancellations, or safety concerns.\n" +
            "A fair dispute resolution process is in place to handle any conflicts between renters and hosts.",
        img: "/home/3.jpg",
        icon: "lightbulb",
    },
];
...
export const exploreWorlds = [
    {
        id: "world-1",
        imgUrl: "/home/4.jpg",
        title: "House Rules & Safety Guidelines",
        description: "Clear rules for renters and hosts ensure smooth stays (e.g., no unauthorized guests, noise policies).",
    },
    {
        id: "world-2",
        imgUrl: "/home/5.jpg",
        title: "Secure Payments & Booking Protection",
        description: "Payments are processed securely through encrypted transactions.",
    },
    {
        id: "world-3",
        imgUrl: "/home/6.jpg",
        title: "Fraud Prevention & Scam Detection",
        description: "Listings flagged for misleading information are reviewed and removed if necessary.",
    },
];
